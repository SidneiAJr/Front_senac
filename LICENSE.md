...
Este código é de **propriedade exclusiva** e está protegido por direitos autorais.
...
- O código pode ser utilizado **apenas para fins educacionais ou pessoais**, e **não pode ser redistribuído** sem autorização expressa do proprietário.

## Como obter permissão:

Se você deseja utilizar este código para outros fins ou redistribuí-lo de qualquer maneira, entre em contato com o proprietário para obter permissão explícita.
